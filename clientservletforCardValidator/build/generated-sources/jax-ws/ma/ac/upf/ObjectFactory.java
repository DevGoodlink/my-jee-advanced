 ...
 * generated in the ma.ac.upf package. 
...
public class ObjectFactory {
    ...
    private final static QName _CreditCard_QNAME = new QName("http://upf.ac.ma/", "creditCard");
    private final static QName _Validate_QNAME = new QName("http://upf.ac.ma/", "validate");
    private final static QName _ValidateResponse_QNAME = new QName("http://upf.ac.ma/", "validateResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ma.ac.upf
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://upf.ac.ma/", name = "creditCard")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://upf.ac.ma/", name = "validate")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://upf.ac.ma/", name = "validateResponse")
