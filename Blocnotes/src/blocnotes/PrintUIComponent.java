...
/**
 *
 * Using the original page to render JTextArea, provides print preview
 * mechanism.  *
 * <p>
 *
 * In fact, we can also through other ways to print JTextArea:  *
 * <ol>
 *
 ...
 *
 */
public class PrintUIComponent extends JPanel implements ActionListener, Printable {
    ...
    public PrintUIComponent() {
        ...
        job.setJobName("Print TextArea");// Appear in the print task list
    ...
    private void createAndShowPreviewDialog() {
        ...
        JDialog previewDialog = new JDialog(frame, "Print Preview Dialogsbai", true);
