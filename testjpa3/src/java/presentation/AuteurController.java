...
import controllerlayer.AuteurFacade;
...
public class AuteurController implements Serializable {
    ...
    @EJB
    private controllerlayer.AuteurFacade ejbFacade;
    ...
    public Auteur getAuteur(java.lang.Integer id) {
    ...
    public static class AuteurControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Auteur) {
                ...
                return getStringKey(o.getIdAuteur());
            } else {
