...
import controllerlayer.LivreFacade;
...
public class LivreController implements Serializable {
    ...
    @EJB
    private controllerlayer.LivreFacade ejbFacade;
    ...
    public Livre getLivre(java.lang.Integer id) {
    ...
    public static class LivreControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getLivre(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Livre) {
                ...
                return getStringKey(o.getIdLivre());
            } else {
